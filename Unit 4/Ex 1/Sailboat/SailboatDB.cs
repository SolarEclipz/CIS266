...
{
    public static class SailboatDB
    {
        private const string Path = @"..\..\Products.xml";

        public static List<Sailboat> GetProducts()
        {
            // create the list
            List<Sailboat> products = new List<Sailboat>();
        ...
        public static void SaveProducts(List<Sailboat> products)
        {
            ...
            foreach (Sailboat product in products)
            {
                xmlOut.WriteStartElement("Product");
                xmlOut.WriteElementString("Code",
                    product.Code);
                xmlOut.WriteElementString("OwnerName",
                    product.OwnerName);
                xmlOut.WriteElementString("NumOfSails",
                    Convert.ToString(product.NumOfSails));
